...
export default function AddressCard({ title, name, address, area, city, phone, isDefault, onEdit, onRemove }: any) {
  return (
    <div className="border-2 border-gray-200 rounded-xl p-5 hover:border-pink-300 transition-colors relative">
      ...
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">{area} , {city}</p>
